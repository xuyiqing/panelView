...
* Added `type = "network"` for visualizing the connectivity structure of panel data as a $k$-partite graph, following the graph-theoretic framework of @correia2016. Features:
...
* Added tutorial chapter: [Network Structure](#sec-network)
